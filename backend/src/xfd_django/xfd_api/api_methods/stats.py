...
from xfd_mini_dl.models import Organization, HostSummary, PortScanSummary, PortScanServiceSummary, VulnScanSummary
...
def get_vs_trending_data(filters, current_user):
    ...
    return {
        ...
        "port_scan_service_summaries": [model_to_dict(obj) for obj in port_scan_service_summaries],
