...
from xfd_api.tasks.vulnScanningSync import enforce_latest_flag_port_scan, create_port_scan_summary, create_daily_host_summary, create_port_scan_service_summaries, create_vuln_scan_summary
def handler(event):
